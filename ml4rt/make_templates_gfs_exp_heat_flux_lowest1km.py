"""Makes templates for GFS experiment with target = heat flux in lowest 1 km."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/gfs_experiment_heat_flux_lowest1km/templates'
...
VECTOR_LOSS_FUNCTION = custom_losses.dual_weighted_mse(23)
VECTOR_LOSS_STRING = 'custom_losses.dual_weighted_mse({0:d})'.format(23)
LOSS_DICT = {
