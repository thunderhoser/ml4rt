...
TRAINING_SCALAR_TARGET_MATRIX = numpy.expand_dims(
    TRAINING_SCALAR_TARGET_MATRIX, axis=-2
)
TRAINING_VECTOR_TARGET_MATRIX = numpy.expand_dims(
    TRAINING_VECTOR_TARGET_MATRIX, axis=-2
)
...
MEAN_SCALAR_TARGET_MATRIX = numpy.expand_dims(
    MEAN_SCALAR_TARGET_MATRIX, axis=-2
)
MEAN_VECTOR_TARGET_MATRIX = numpy.expand_dims(
    MEAN_VECTOR_TARGET_MATRIX, axis=-2
)
