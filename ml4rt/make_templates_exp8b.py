"""Makes U-net templates for Experiment 8b."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4rt_models/experiment08b/templates'.format(
    HOME_DIR_NAME
)

DENSE_LAYER_COUNTS = numpy.array([3], dtype=int)
DENSE_LAYER_DROPOUT_RATES = numpy.array([0.1])
L2_WEIGHTS = numpy.array([10 ** -6.5])

NUM_LEVELS = 4
VECTOR_LOSS_FUNCTION = custom_losses.dual_weighted_mse()

SCALAR_LOSS_FUNCTION = custom_losses.scaled_mse(1.)
SCALAR_LOSS_STRING = (
    'custom_losses.scaled_mse({0:.10f})'.format(1.)
)
LOSS_DICT = {
