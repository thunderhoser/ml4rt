...
Same as actual Experiment 2 but with simpler loss function (equal band weights).
"""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/spectral_experiment02_simple/shortwave_plusplus/templates'
