...
DEFAULT_OPTION_DICT = {
    ...
    u_net_pp_architecture.DO_INLINE_NORMALIZATION_KEY: True,
    u_net_pp_architecture.PW_LINEAR_UNIF_MODEL_KEY:
        PW_LINEAR_UNIF_MODEL_FILE_NAME,
    u_net_pp_architecture.SCALAR_PREDICTORS_KEY: SCALAR_PREDICTOR_NAMES,
    u_net_pp_architecture.VECTOR_PREDICTORS_KEY: VECTOR_PREDICTOR_NAMES,
    u_net_pp_architecture.HEIGHTS_KEY: GRID_HEIGHTS_M_AGL
}
