"""Plots data overview (selected predictor/target vars) for each example."""
...
def _plot_one_example(example_dict, example_index, use_log_scale,
    ...
    predictor_names_by_set = [
        FIRST_PREDICTOR_NAMES, SECOND_PREDICTOR_NAMES,
        THIRD_PREDICTOR_NAMES, FOURTH_PREDICTOR_NAMES
    ]
...
def _run(example_file_name, num_examples, example_dir_name,
    ...
    if model_file_name != '':
        ...
        all_field_names = vector_predictor_names + TARGET_NAMES
