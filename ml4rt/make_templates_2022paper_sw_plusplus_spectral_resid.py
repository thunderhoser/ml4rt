"""Makes templates for shortwave U-net++ models without deep supervision.

Following the experiment in the 2022 paper, except for spectrally resolved
instead of broadband.

'The 2022 paper' (actually 2023) = https://doi.org/10.1175/JTECH-D-23-0012.1
"""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/2022paper_experiment_sw_plusplus_spectral_resid/'
    'templates'
...
DEFAULT_OPTION_DICT = {
    ...
    u_net_pp_architecture.USE_RESIDUAL_BLOCKS_KEY: True,
    ...
    u_net_pp_architecture.NUM_OUTPUT_WAVELENGTHS_KEY: 14,
    ...
    u_net_pp_architecture.PW_LINEAR_UNIF_MODEL_KEY: None,
    u_net_pp_architecture.VECTOR_PREDICTORS_KEY: None,
    u_net_pp_architecture.SCALAR_PREDICTORS_KEY: None,
    u_net_pp_architecture.HEIGHTS_KEY: None
}
        ...
        for j in range(num_conv_layer_counts):
            for k in range(num_channel_counts):
                ...
                this_option_dict.update({
                    u_net_pp_architecture.NUM_LEVELS_KEY: MODEL_DEPTHS[i],
                    u_net_pp_architecture.CONV_LAYER_COUNTS_KEY:
                        numpy.full(
