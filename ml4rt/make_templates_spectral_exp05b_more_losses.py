"""Makes templates for Spectral Experiment 5b.

Same as Spectral Experiment 5 but with simpler normalization.
"""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/spectral_experiment05b_more_losses/templates'
