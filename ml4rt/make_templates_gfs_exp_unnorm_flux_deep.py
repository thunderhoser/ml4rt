"""Makes templates for GFS experiment with unnorm fluxes and deep supervis."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/gfs_experiment_unnorm_flux_deep/templates'
...
def _run():
    ...
    for i in range(num_scaling_factors):
        this_scalar_loss_function = custom_losses.scaled_mse_for_net_flux(
