"""Makes U-net template for test with GFS data."""
...
OUTPUT_DIR_NAME = '{0:s}/ml4rt_models/gfs/test/template'.format(HOME_DIR_NAME)
...
def _run():
    ...
    for i in range(num_dense_layer_counts):
        these_neuron_counts = architecture_utils.get_dense_layer_dimensions(
            num_input_units=5 * 1024, num_classes=2,
