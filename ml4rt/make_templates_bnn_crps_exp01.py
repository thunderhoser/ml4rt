"""Makes templates for first shortwave experiment with CRPS-trained BNNs."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/shortwave_bnn_crps_experiment01/templates'
...
DEFAULT_OPTION_DICT = {
    ...
    u_net_pp_architecture.ENSEMBLE_SIZE_KEY: ENSEMBLE_SIZE
}
