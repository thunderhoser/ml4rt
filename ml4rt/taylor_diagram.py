...
class TaylorDiagram(object):
    ...
    def __init__(
            self, refstd, fig=None, rect=111, label='_', srange=(0, 1.5),
            extend=False, plot_reference_line=True):
        """
        ...
        * plot_reference_line: Boolean flag.  If True, plots reference line
            showing `refstd`.  If False, does not plot this line.
        """
