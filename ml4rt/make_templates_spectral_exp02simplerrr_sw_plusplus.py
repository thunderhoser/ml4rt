...
Same as actual Experiment 2 but with much simpler loss function (no band weights
or constraints) and more dense-layer neurons.
"""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/spectral_experiment02_simplerrr/shortwave_plusplus/'
    'templates'
...
VECTOR_LOSS_FUNCTION_STRING = 'custom_losses.dual_weighted_mse_simple()'
SCALAR_LOSS_FUNCTION_STRING = (
    'custom_losses.scaled_mse_for_net_flux(scaling_factor=1., band_weights=None)'
)
LOSS_DICT = {
