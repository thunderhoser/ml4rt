...
EXAMPLE_DIR_NAME="/scratch1/RDARCH/rda-ghpcs/Ryan.Lagerquist/ml4rt_project/gfs_data/shortwave_examples_600days/orig_heights/normalized_with_perturbed_training_data/validation_all_perturbed_for_uq"
...
prediction_file_name="${model_dir_name}/validation_perturbed_for_uq/${PATHLESS_OUTPUT_FILE_NAMES[$prediction_file_index]}"
