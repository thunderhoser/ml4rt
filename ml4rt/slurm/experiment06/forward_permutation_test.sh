...
--output_file_name="${model_dir_name}/validation/forward_permutation_test_mse.nc"

"${PYTHON_EXE_NAME}" -u "${CODE_DIR_NAME}/scripts/plot_permutation_results.py" \
--input_file_name="${model_dir_name}/validation/forward_permutation_test_mse.nc" \
--confidence_level=0.95 \
--output_dir_name="${model_dir_name}/validation/forward_permutation_test_mse"
...
--num_bootstrap_reps=1000 \
--output_file_name="${model_dir_name}/validation/forward_permutation_test_dwmse.nc"

"${PYTHON_EXE_NAME}" -u "${CODE_DIR_NAME}/scripts/plot_permutation_results.py" \
--input_file_name="${model_dir_name}/validation/forward_permutation_test_dwmse.nc" \
--confidence_level=0.95 \
--output_dir_name="${model_dir_name}/validation/forward_permutation_test_dwmse"
