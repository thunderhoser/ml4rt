...
def _plot_one_example(
        example_dict, example_index, plot_targets, target_wavelength_metres,
        output_dir_name):
    ...
    :param plot_targets: See documentation at top of this script.
...
def _run(example_file_name, num_examples, example_dir_name,
         example_id_file_name, plot_targets, target_wavelength_metres,
         output_dir_name):
    """Plots profiles (5 predictor variables).
