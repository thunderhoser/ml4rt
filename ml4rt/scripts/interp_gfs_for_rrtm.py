...
VAPOUR_MIXR_KEY = 'vapour_mixing_ratio_kg_kg01'
...
OZONE_MIXR_KEY = 'ozone_mixing_ratio_kg_kg01'
...
INTERP_KEYS = [
    PRESSURE_KEY, PRESSURE_AT_EDGE_KEY, TEMPERATURE_KEY, VAPOUR_MIXR_KEY,
    LIQUID_WATER_PATH_KEY, RAIN_WATER_PATH_KEY, ICE_WATER_PATH_KEY,
    GRAUPEL_PATH_KEY, SNOW_PATH_KEY, OZONE_MIXR_KEY, O2_CONCENTRATION_KEY,
    CO2_CONCENTRATION_KEY, CH4_CONCENTRATION_KEY, N2O_CONCENTRATION_KEY,
    LIQUID_EFF_RADIUS_KEY, ICE_EFF_RADIUS_KEY, CLOUD_FRACTION_KEY,
    AEROSOL_EXTINCTION_KEY
]
CONSERVE_JUMP_KEYS = [
    LIQUID_WATER_PATH_KEY, RAIN_WATER_PATH_KEY, ICE_WATER_PATH_KEY,
    GRAUPEL_PATH_KEY, SNOW_PATH_KEY
]
SCALAR_KEYS = [
...
def _mixing_ratio_to_layerwise_path(orig_gfs_table_xarray, new_heights_m_agl,
    ...
    vapour_pressure_matrix_pa = moisture_conv.mixing_ratio_to_vapour_pressure(
        mixing_ratios_kg_kg01=interp_data_dict[VAPOUR_MIXR_KEY],
...
def _layerwise_path_to_mixing_ratio(orig_gfs_table_xarray, variable_name):
    ...
    :return: orig_gfs_table_xarray: Same as input but with mixing ratios instead
        of layerwise paths.
    """
    ...
    layerwise_path_matrix_kg_m02 = numpy.reshape(
        orig_gfs_table_xarray[variable_name].values,
    ...
    vapour_pressure_matrix_pa = moisture_conv.mixing_ratio_to_vapour_pressure(
        mixing_ratios_kg_kg01=orig_gfs_table_xarray[VAPOUR_MIXR_KEY].values,
    ...
    orig_gfs_table_xarray[variable_name].values = mixing_ratio_matrix_kg_kg01

    return orig_gfs_table_xarray
