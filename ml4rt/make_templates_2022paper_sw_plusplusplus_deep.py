"""Makes templates for shortwave U-net3+ models with deep sup in 2022 paper."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/2022paper_experiment_sw_plusplusplus_deep/templates'
...
DEFAULT_OPTION_DICT = {
    ...
    u_net_ppp_architecture.CONV_OUTPUT_ACTIV_FUNC_KEY:
        architecture_utils.RELU_FUNCTION_STRING,
    u_net_ppp_architecture.CONV_OUTPUT_ACTIV_FUNC_ALPHA_KEY: 0.,
