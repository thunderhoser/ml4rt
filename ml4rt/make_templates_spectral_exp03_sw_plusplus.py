"""Makes U-net++ templates for Exp 3 with spectrally resolved shortwave RT.

Same as Experiment 1 but with residual blocks and target-masking.
"""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/spectral_experiment03/shortwave_plusplus/templates'
