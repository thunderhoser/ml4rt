...
docker run -it --userns=host -u `id -u`:`id -g` -v "/home/ralager/condo/swatwork/ralager/scratch1/RDARCH/rda-ghpcs/Ryan.Lagerquist/ml4rt_project/gfs_data/new_heights":"/home/user/data" ${argv[1]} 
