...
cp -v "${GITHUB_CODE_DIR_NAME}/runit_ML_dataset_builder_orig-heights_simple-aerosol.pro" "${TOP_DATA_DIR_NAME_ACTUAL}/"
...
echo ".run /home/user/data/runit_ML_dataset_builder_orig-heights_simple-aerosol.pro" >> $gdl_script_file_name
