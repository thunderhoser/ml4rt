"""Makes U-net templates for first experiment with 192 heights."""
...
TOP_OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/192heights/experiment01/templates'
...
DEFAULT_OPTION_DICT = {
    ...
    u_net_pp_architecture.CHANNEL_COUNTS_KEY:
        numpy.array([32, 64, 128, 256, 512, 1024], dtype=int),
...
def _run():
    ...
    for i in range(num_dense_layer_counts):
        these_neuron_counts = architecture_utils.get_dense_layer_dimensions(
            num_input_units=6 * 1024, num_classes=2,
        ...
        for j in range(num_dropout_rates):
            ...
            for k in range(num_l2_weights):
                ...
                this_model_file_name = (
                    ...
                    TOP_OUTPUT_DIR_NAME, DENSE_LAYER_COUNTS[i],
