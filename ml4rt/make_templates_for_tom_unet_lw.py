"""Makes U-net templates for Tom Beucler, longwave only."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/tom_experiment_lw/u_net/templates'
...
DEFAULT_OPTION_DICT = {
    ...
    u_net_architecture.CONV_OUTPUT_ACTIV_FUNC_KEY: None,
