"""Makes templates for best shortwave model in 2022 paper."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/2022paper_experiment_sw_plusplus_best_1output/template'
    ...
    for i in range(num_depths):
        for j in range(num_conv_layer_counts):
            for k in range(num_channel_counts):
                ...
                this_model_object = (
                    u_net_pp_architecture.create_model_1output_layer(
