"""Creates 8-panel figure showing evaluation metrics for one model."""
...
def _get_input_files_1wavelength(input_dir_name, wavelength_metres):
...
def _run(input_dir_name, wavelengths_metres, output_dir_name):
    """Creates 8-panel figure showing evaluation metrics for one model.
