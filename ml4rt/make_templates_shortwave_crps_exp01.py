"""Makes templates for first shortwave experiment with only CRPS for UQ."""
...
OUTPUT_DIR_NAME = (
    '{0:s}/ml4rt_models/shortwave_crps_experiment01/template'
...
DENSE_LAYER_NEURON_COUNTS[-1] = 2 * ENSEMBLE_SIZE
