...
pro runit, year
  ...
  sites = [" YOPP Arctic Ocean Site 1", $
  	   " YOPP Arctic Ocean Site 2 (North Pole)", $
	   " FINO3 tower (North Sea)", $
	   " DWD Lindenberg Observatory (Lindenberg Germany)", $
	   " Pallas-Sodankyla - land", $
	   " Tiksi (Russia) - ocean", $
	   " Cherskii (Russia) - ocean", $
	   " SHEBA location ", $
	   " YOPP Arctic Ocean Site 3", $
	   " Alert (Canada) - land", $
  	   " Summit Station (Greenland) - land", $
  	   " Villum (Greenland) - land", $
  	   " ARM enaC1 site (Azores)"]
