...
def _run(input_prediction_file_name, for_shortwave,
    ...
    prediction_io.write_file(
        ...
        isotonic_model_file_name=
        large_hr_prediction_dict[prediction_io.ISOTONIC_MODEL_FILE_KEY],
        uncertainty_calib_model_file_name=large_hr_prediction_dict[
            prediction_io.UNCERTAINTY_CALIB_MODEL_FILE_KEY
        ],
        normalization_file_name=
    ...
    prediction_io.write_file(
        ...
        isotonic_model_file_name=
        small_hr_prediction_dict[prediction_io.ISOTONIC_MODEL_FILE_KEY],
        uncertainty_calib_model_file_name=small_hr_prediction_dict[
            prediction_io.UNCERTAINTY_CALIB_MODEL_FILE_KEY
        ],
        normalization_file_name=
